...
jest.mock("../../../src/layers/svg/choroplethSvgLayer", () => ({
  ChoroplethSvgLayer: jest.fn().mockImplementation(() => ({ setSelectedIds: jest.fn(), setActive: jest.fn(), getFeaturesExtent: jest.fn().mockReturnValue([0, 0, 1, 1]) }))
}));
