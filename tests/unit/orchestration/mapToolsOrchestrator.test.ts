...
class MockMapService {
  ...
  zoomInteractionsEnabled: boolean = true;
  ...
  disableZoomInteractions() { this.zoomInteractionsEnabled = false; }
  enableZoomInteractions() { this.zoomInteractionsEnabled = true; }
}
